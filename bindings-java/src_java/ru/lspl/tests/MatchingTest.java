...
public class MatchingTest {
	...
	public static void main( String[] args ) throws Exception {
		...
		Text t3 = Text
				.create( "Указанную операцию назовем операцией поиска примеров, фразу Поддержку динамичности изменения доступного информационного пространства мы назовем динамичностью информационной модели" );
